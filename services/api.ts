...
const DEMO_DATA_ZH: DashboardMetrics = {
  ...
  hospitals: [
    { 
      id: 1, 
      name: '上海交通大学九院',
      description: '上海交通大学医学院附属第九人民医院的前身“伯特利医院”创建于1920年。九院是一所学科特色鲜明、具备深厚临床基础和科研实力的三级甲等综合性医院。在口腔医学、整复外科、骨科等领域享有国际声誉。作为数字化医疗的先行者，九院与上海交通大学平台深度合作，开展个性化3D打印植入物及康复辅具的临床应用。'
    },
    { 
      id: 2, 
      name: '上海交通大学瑞金医院',
    ...
    { 
      id: 4, 
      name: '日照市国际健康管理中心',
      description: '日照市国际健康管理中心是一家集健康体检、健康管理、康复理疗为一体的现代化健康服务机构。引入上海交通大学云平台后，中心实现了远程定制化矫形支具的快速交付，服务范围辐射周边城市。'
    },
    { 
      id: 5, 
      name: '深圳平乐中心',
